                    ...
                    <div>
                      <ul class="rrssb-buttons">
                        <li class="rrssb-facebook">
                          <a href="https://www.facebook.com/sharer/sharer.php?u=http://jevticnekretnine.rs/detalji/<?php echo $stan[0] . '/' . $stan['kategorija'] . '-' . str_replace(' ', '-', $stan['tip']) . '-' . str_replace(' ', '-', $stan['opstina']) ?>/" class="popup">
                        ...
                        <li class="rrssb-twitter">
                          <a href="https://twitter.com/intent/tweet?text=http://jevticnekretnine.rs/detalji/<?php echo $stan[0] . '/' . $stan['kategorija'] . '-' . str_replace(' ', '-', $stan['tip']) . '-' . str_replace(' ', '-', $stan['opstina']) ?>/"
                          class="popup">
                            <span class="rrssb-icon">
                        ...
                        <li class="rrssb-googleplus">
                          ...
                          <a href="https://plus.google.com/share?url=Check%20out%20how%20ridiculously%20responsive%20these%20social%20buttons%20are%20http://jevticnekretnine.rs/detalji/<?php echo $stan[0] . '/' . $stan['kategorija'] . '-' . str_replace(' ', '-', $stan['tip']) . '-' . str_replace(' ', '-', $stan['opstina']) ?>/" class="popup">
                            <span class="rrssb-icon">
                        ...
                        <li class="rrssb-linkedin">
                          <!-- Replace href with your meta and URL information -->
                          <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=http://jevticnekretnine.rs/detalji/<?php echo $stan[0] . '/' . $stan['kategorija'] . '-' . str_replace(' ', '-', $stan['tip']) . '-' . str_replace(' ', '-', $stan['opstina']) ?>/" class="popup">
                            <span class="rrssb-icon">
                        ...
                        <li class="rrssb-viber">
                          <a href="viber://forward?text=http://jevticnekretnine.rs/detalji/<?php echo $stan[0] . '/' . $stan['kategorija'] . '-' . str_replace(' ', '-', $stan['tip']) . '-' . str_replace(' ', '-', $stan['opstina']) ?>/" data-action="share/viber/share">
                            <span class="rrssb-icon">
