...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  ...
	  var insertItems = _.debounce(function () {
	    ...
	    setTimeout(function () {
	      var $demoItems = $list.find('.listing__item:lt(9)').clone();
	  ...
	  var page = 0;
	  var forma = $('#searchForm').serialize();
	  var category = $('#searchForm').attr("data-cat");
	  var order = $('select[name=sortiranje]').val();
