...
if($_SESSION['uloga'] != 1)
{
    header('Location: login.php');
                    ...
                    $p_num = $items*($page - 1);
                    $agencije = prikaziSveBrojeve($p_num, $items);
...
<div class="nav-outer">
		...
		<div class="select_sub show">
			<ul class="sub">
			    <li><a href="imenik.php">Imenik</a></li>
                            <li class="sub_show"><a href="spisak_agencija.php">Spisak agencija</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<th class="table-header-repeat line-left"><a href="">Agencija</a></th>
					<th class="table-header-repeat line-left"><a href="">Broj</a></th>
				...
				?>
				<tr>
					<td><?php echo $agencija['agencija'];?></td>
					<td><?php echo $agencija['broj'];?></td>
                                        <td class="options-width">
					<a href="izbrisi_broj.php?id=<?php echo $agencija['id'];?>" title="Obrisi" class="icon-2 info-tooltip"></a>
			...
			if($page_amount != "0"){
				if($page != "0"){
					...
					echo '<a href="spisak_agencija.php?stranica='.$prev.'" class="page-left"></a>';
				}
				...
				if($page < $page_amount){
					...
					echo '<a href="spisak_agencija.php?stranica='.$next.'" class="page-right"></a>';
				}
