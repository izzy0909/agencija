...
<tr>
	...
	<td>
		...
		<tr>
		<th valign="top">Agencija:</th>
		<td><input type="text" class="inp-form" name="agencija" /></td>
		<td></td>
		</tr>

	<tr>
		<th valign="top">Broj:</th>
		<td><input type="text" class="inp-form" name="broj" /></td>
		<td></td>
	</tr>
	...
	<tr>
		...
		<td valign="top">
                        ...
                        <input type="submit" value="Dodaj" class="form-submit" name="dodaj_broj" id="dodaj_broj" />
